...
/* themes/custom/news_vision/templates/menu--popular-tags.html.twig */
class __TwigTemplate_0f34f204c50556b8a8eeb839345c67ec44669896a70fae56898355b973a86d2c extends \Twig\Template
{
...
$context["item"], "in_active_trail", [])) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return "themes/custom/news_vision/templates/menu--popular-tags.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      <li{{ item.attributes.addClass(classes) }}>
        {{ link(item.title, item.url, { 'class':['fh5co_tagg']}) }}
        {% if item.below %}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/news_vision/templates/menu--popular-tags.html.twig", "C:\\Users\\Ayush\\Sites\\devdesktop\\news-theme\\themes\\custom\\news_vision\\templates\\menu--popular-tags.html.twig");
    }
}
