...
/* themes/custom/news_vision/templates/pager.html.twig */
class __TwigTemplate_59ebefa219e77113cc47dfc9edb7d21b5237d74c2b66b2043ae8e0131f43db88 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["items"] ?? null)) {
            // line 34
            echo "<div class=\"row mx-0\" data-animate-effect=\"fadeInUp\">
    ...
    <ul class=\"pager__items js-pager__items\">
      ...
      ";
            ...
            if ($this->getAttribute(($context["ellipses"] ?? null), "previous", [])) {
                // line 59
                echo "        <li class=\"pager__item pager__item--ellipsis btn_pagging\" role=\"presentation\">&hellip;</li>
      ";
            }
            // line 61
            echo "      ";
...
";
    ...
    {
        return "themes/custom/news_vision/templates/pager.html.twig";
    }
    ...
    {
        return array (  246 => 99,  239 => 95,  235 => 94,  227 => 93,  224 => 92,  221 => 91,  219 => 90,  212 => 86,  208 => 85,  200 => 84,  197 => 83,  194 => 82,  192 => 81,  188 => 79,  185 => 78,  183 => 77,  175 => 74,  173 => 73,  169 => 71,  159 => 69,  156 => 68,  153 => 67,  150 => 66,  147 => 65,  145 => 64,  140 => 63,  135 => 62,  133 => 61,  129 => 59,  126 => 58,  124 => 57,  117 => 53,  113 => 52,  105 => 51,  102 => 50,  99 => 49,  97 => 48,  90 => 44,  86 => 43,  78 => 42,  75 => 41,  72 => 40,  65 => 37,  61 => 36,  57 => 34,  55 => 33,);
    }
    ...
    <ul class=\"pager__items js-pager__items\">
      ...
      {% if items.first %}
        <li class=\"pager__item pager__item--first\">
          <a href=\"{{ items.first.href }}\" title=\"{{ 'Go to first page'|t }}\"{{ items.first.attributes|without('href', 'title') }} class=\"btn_pagging\">
      ...
      {% if items.previous %}
        <li class=\"pager__item pager__item--previous\">
          <a href=\"{{ items.previous.href }}\" title=\"{{ 'Go to previous page'|t }}\" rel=\"prev\"{{ items.previous.attributes|without('href', 'title', 'rel') }} class=\"btn_mange_pagging\">
      ...
      {% if ellipses.previous %}
        <li class=\"pager__item pager__item--ellipsis btn_pagging\" role=\"presentation\">&hellip;</li>
      {% endif %}
      ...
      {% for key, item in items.pages %}
        <li class=\"pager__item{{ current == key ? ' is-active' : '' }}\">
          ...
          {% endif %}
          <a href=\"{{ item.href }}\" title=\"{{ title }}\"{{ item.attributes|without('href', 'title') }} class=\"btn_pagging\">
            <span class=\"visually-hidden\">
      ...
      {% if items.next %}
        <li class=\"pager__item pager__item--next\">
          <a href=\"{{ items.next.href }}\" title=\"{{ 'Go to next page'|t }}\" rel=\"next\"{{ items.next.attributes|without('href', 'title', 'rel') }} class=\"btn_mange_pagging\">
      ...
      {% if items.last %}
        <li class=\"pager__item pager__item--last\">
          <a href=\"{{ items.last.href }}\" title=\"{{ 'Go to last page'|t }}\"{{ items.last.attributes|without('href', 'title') }} class=\"btn_pagging\">
...
{% endif %}
", "themes/custom/news_vision/templates/pager.html.twig", "C:\\Users\\Ayush\\Sites\\devdesktop\\news-theme\\themes\\custom\\news_vision\\templates\\pager.html.twig");
    }
}
